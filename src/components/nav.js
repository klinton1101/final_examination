...
<Box sx={{width:"100%", display:"flex", justifyContent:"center", alignItems:"center", textAlign:"center", flexDirection:"column",}}>   
      <IconButton
          ...
          >
             {localStorage.getItem("active") ? <Avatar src={localStorage.getItem("photo")}></Avatar> : <AccountCircleIcon />}
        
          </IconButton>
 
          <Typography color="textPrimary"
            sx={localStorage.getItem("active") ? { display: "block", fontSize:"15px", textAlign:"center"} : { display: "none" }}
          >
            {" "}
            {localStorage.getItem("active") ? localStorage.getItem("name") : ""}
          </Typography>
  </Box>
          <Popover
            id={id}
          ...
          >
            ...
            >
              <Typography
                sx={localStorage.getItem("active")? { display: "none" } : { display: "block" }}
              >
                Log in via:{" "}
              </Typography>
              &nbsp; &nbsp;
              ...
              <Button
                ...
                sx={localStorage.getItem("active")? { display: "block" } : { display: "none" }}
              >
                {" "}
                LOG OUT
              </Button>
    ...
    <Box sx={style.root}>
      <AppBar position="static" sx={style.appbar}>
        <Toolbar sx={{ paddingLeft: 2 }}>
          ...
          <Typography color="textPrimary"
            sx={localStorage.getItem("active") ? { display: {
              xs:"none",
              sm:"none",
